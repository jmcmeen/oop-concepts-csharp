...
namespace ChatClient
{
    public partial class ChatBoxForm : Form
    {
        ...
        public ChatBoxForm(TcpClient server, String name)
        {
            this.server = server;
            this.name = name;
            InitializeComponent();
        ...
        private void ChatBox_Load(object sender, EventArgs e)
        {
            ...
            var mainThread = new Thread(() => receiveThread());
            mainThread.Start();
        ...
        {
            new Thread(() => Application.Run(new GroupCreatorForm(server))).Start();
        }
                    ...
                    switch (infoJson.type)
                    {
                        ...
                        case "FILE":
                            if (infoJson.content != null)
                            {
                                ...
                                {
                                    new Thread(() => Application.Run(new ImageForm(bufferFile))).Start();
        ...
        private void AppendRichTextBox(string sender, string receiver, string message, string link)
        {
            ...
            {
                System.Drawing.Font currentFont = rtbDialog.SelectionFont;

                //Username
                rtbDialog.SelectionStart = rtbDialog.TextLength;
                rtbDialog.SelectionLength = 0;
                rtbDialog.SelectionColor = Color.Red;
                rtbDialog.SelectionFont = new System.Drawing.Font(currentFont.FontFamily, currentFont.Size, FontStyle.Bold);
                ...
                rtbDialog.SelectionFont = new System.Drawing.Font(currentFont.FontFamily, currentFont.Size, FontStyle.Regular);
                ...
                rtbDialog.SelectionFont = new System.Drawing.Font(currentFont.FontFamily, currentFont.Size, FontStyle.Underline);
